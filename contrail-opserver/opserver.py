...
class OpServer(object):
    ...
    def get_fq_name_obj_perms(self, name, uve_type):
        try:
    ...
    #end update_where_clause_for_range
        ...
        try:
            ...
            for key in filters['kfilt']:
                ...
                if rsp != {}:
                    ...
                    #        continue
                    rv_obj_perms = self.get_fq_name_obj_perms(key, uve_type) 
                    if ((rv_obj_perms is not None and \
    ...
    def dyn_http_get(self, table, name):
        ...
        if name.find('*') != -1:
            ...
            rv_obj_perms = self.get_fq_name_obj_perms(name, table)
