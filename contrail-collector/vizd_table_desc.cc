 ...
 */
    ...
    flow_msg2type_map[g_viz_constants.FlowRecordNames[FlowRecordFields::FLOWREC_VMI]] =
         FlowTypeInfo(FlowRecordFields::FLOWREC_VMI, GenDb::DbDataType::LexicalUUIDType);
